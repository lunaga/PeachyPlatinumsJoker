...
const products = [
    ...
    {
        id: "18",
        name: "Hollow knight PS4 Platinum Trophy Service",
    ...
    {
        id: "283",
        name: "Atelier Ryza  1DX PS4 Platinum Trophy Service",
        description: "JRPG",
        price: 75,
        category: "ps4",
    ...
    {
        id: "284",
        name: "Atelier Ryza  1DX PS5 Platinum Trophy Service",
        description: "JRPG",
        price: 75,
        category: "ps5",
    ...
    {
        id: "285",
        name: "Atelier Ryza 2DX PS4 Platinum Trophy Service",
        description: "JRPG",
        price: 85,
        category: "ps4",
    ...
    {
        id: "286",
        name: "Atelier Ryza 2DX PS5 Platinum Trophy Service",
        description: "JRPG",
        price: 85,
        category: "ps5",
    ...
    {
        id: "287",
        name: "Atelier Ryza 3DX PS4 Platinum Trophy Service",
        description: "JRPG",
        price: 80,
        category: "ps4",
    ...
    {
        id: "288",
        name: "Atelier Ryza 3DX PS5 Platinum Trophy Service",
        description: "JRPG",
        price: 80,
        category: "ps5",
    ...
    {
        id: "302",
        name: "Grand Theft Auto Definitive Edition Trilogy Bundle PS5 Platinum Trophy Service",
    ...
    },
    {
        ...
        {
        id: "304",
        name: "Grand Theft Auto Definitive Edition Trilogy Bundle PS4 Platinum Trophy Service",
        description: "Open world bundle",
        price: 230,
        category: "bundles",
        image: "images/games/304.jpg",
    },
...
export default function StorePage() {
    ...
    const newlyAddedGames = [
        products.find((p) => p.id === "305"),
        products.find((p) => p.id === "306"),
        products.find((p) => p.id === "307"),
        products.find((p) => p.id === "308"),
        products.find((p) => p.id === "309"),
        products.find((p) => p.id === "310"),
        products.find((p) => p.id === "311"),
        products.find((p) => p.id === "312"),
        products.find((p) => p.id === "313"),
        products.find((p) => p.id === "314"),
        products.find((p) => p.id === "315"),
        products.find((p) => p.id === "316"),
        products.find((p) => p.id === "317"),
        products.find((p) => p.id === "318"),
        products.find((p) => p.id === "319"),
        products.find((p) => p.id === "320"),
        products.find((p) => p.id === "321"),
        products.find((p) => p.id === "322"),
        products.find((p) => p.id === "323"),
        products.find((p) => p.id === "324"),
        products.find((p) => p.id === "325"),
        products.find((p) => p.id === "326"),
        products.find((p) => p.id === "327"),
        products.find((p) => p.id === "328"),
        products.find((p) => p.id === "329"),
