...
export default function StorePage() {
    ...
    const newlyAddedGames = [
        products.find((p) => p.id === "279"),
        products.find((p) => p.id === "280"),
        products.find((p) => p.id === "281"),
        products.find((p) => p.id === "282"),
        products.find((p) => p.id === "283"),
        products.find((p) => p.id === "284"),
        products.find((p) => p.id === "285"),
        products.find((p) => p.id === "286"),
        products.find((p) => p.id === "287"),
        products.find((p) => p.id === "288"),
        products.find((p) => p.id === "289"),
        products.find((p) => p.id === "290"),
        products.find((p) => p.id === "291"),
        products.find((p) => p.id === "292"),
        products.find((p) => p.id === "293"),
        products.find((p) => p.id === "294"),
        products.find((p) => p.id === "295"),
        products.find((p) => p.id === "296"),
        products.find((p) => p.id === "297"),
        products.find((p) => p.id === "298"),
        products.find((p) => p.id === "299"),
        products.find((p) => p.id === "300"),
        products.find((p) => p.id === "301"),
        products.find((p) => p.id === "302"),
        products.find((p) => p.id === "303"),
