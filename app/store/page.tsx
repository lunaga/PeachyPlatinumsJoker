...
export default function StorePage() {
   ...
   products.find((p) => p.id === "220"),
        products.find((p) => p.id === "221"),
        products.find((p) => p.id === "222"),
        products.find((p) => p.id === "223"),
        products.find((p) => p.id === "224"),
        products.find((p) => p.id === "225"),
        products.find((p) => p.id === "226"),
        products.find((p) => p.id === "227"),
        products.find((p) => p.id === "228"),
        products.find((p) => p.id === "229"),
        products.find((p) => p.id === "230"),
        products.find((p) => p.id === "231"),
        products.find((p) => p.id === "232"),
        products.find((p) => p.id === "233"),
        products.find((p) => p.id === "234"),
        products.find((p) => p.id === "235"),
        products.find((p) => p.id === "236"),
        products.find((p) => p.id === "237"),
        products.find((p) => p.id === "238"),
        products.find((p) => p.id === "239"),
        products.find((p) => p.id === "240"),
        products.find((p) => p.id === "241"),
    ].filter(Boolean)
