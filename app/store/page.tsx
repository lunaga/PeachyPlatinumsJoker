...
const products = [
    ...
    {
        id: "209",
        name: "Ghost of Yōtei + DLC PS5 Platinum Trophy Service",
...
export default function StorePage() {
    ...
    const newlyAddedGames = [
        products.find((p) => p.id === "274"),
        products.find((p) => p.id === "275"),
        products.find((p) => p.id === "276"),
        products.find((p) => p.id === "277"),
        products.find((p) => p.id === "278"),
